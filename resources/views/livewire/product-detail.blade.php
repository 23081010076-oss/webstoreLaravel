            ...
            <div class="md:col-span-3">
                <div class="flex flex-col gap-2">
                    <div>
                        ...
                        <h2 class="text-sm text-gray-800 dark:text-gray-300">{{ $product->short_desc }}</h2>
                        <h3 class="text-xs text-gray-500 dark:text-gray-400">sku: {{ $product->sku }}</h3>
                    </div>
                    <span class="mt-2 text-2xl font-bold dark:text-white">{{ $product->price_formated }}</span>
                </div>
                <div>
