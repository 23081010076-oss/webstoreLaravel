...
<div class="flex items-center gap-5 pb-5 border-b border-gray-200">
    <div class="relative w-40 h-40 overflow-hidden rounded-xl">
        <img class="object-cover size-full"
            src="{{ $item->product?->cover_url ?: 'https://images.unsplash.com/photo-1546087513-2a2bc7fb6fa9?q=80&w=2487&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D' }}"
    ...
    <div class="flex items-center">
        <div class="py-5">
            ...
            <h2 class="text-sm text-gray-800">{{ $item->sku }}</h2>
            <div class="flex items-center gap-2 my-5">
                    ...
                    <div
                        ...
                        <div class="flex items-center gap-x-1.5">
                            ...
                            <input
                                ...
                                style="-moz-appearance: textfield;" type="number" value="{{ $item->quantity }}" readonly>
                ...
                <p class="px-3 py-2 mt-1 text-xl font-semibold text-black dark:text-neutral-200">
                ...
                <button type="button"
                    ...
                    class="ms-4 text-red-500 hover:text-red-700 dark:text-red-400 dark:hover:text-red-300 focus:outline-hidden"
